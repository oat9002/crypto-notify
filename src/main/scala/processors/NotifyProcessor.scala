...
class NotifyProcessorImpl(using configuration: Configuration, notificationService: NotificationService, userService: UserService)(using system: ActorSystem[Nothing], context: ExecutionContext)
